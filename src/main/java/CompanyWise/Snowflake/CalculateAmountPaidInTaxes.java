...
bracket has an upper bound of upperi and is taxed at a rate of percenti.
...
public class CalculateAmountPaidInTaxes {
    ...
    private static double calculateTax(int[][] brackets, int income) {
        ...
        for (int[] bracket : brackets) {
            ...
            int taxableAmount = Math.min(income, upperBound) - previousUpperBound;

            tax = tax + (taxableAmount * percent) / 100.0;
