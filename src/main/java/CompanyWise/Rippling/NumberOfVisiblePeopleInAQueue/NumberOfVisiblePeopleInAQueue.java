...
/**
 * 💡 IDEA
 * A monotonic stack is a specialized data structure, maintaining elements in strictly increasing or decreasing order,
 * designed to solve next/previous greater/smaller element problems in O(n) linear time. As elements are pushed,
 * the stack pops existing elements that violate the order, ensuring each element is processed efficiently
 */
...
Condition:
    ...
    Pop 9 because 11 blocks it for everyone on the left.
