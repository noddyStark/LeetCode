 ...
 * <p>
 * If the stream of the integers is not empty, pick the next integer from the stream and push it to the top
 * of the stack.
 ...
 * valid answers, return any of them.
 * <p>
 * <p>
 * <p>
 * Example 1:
...
public class BuildAnArrayWithStackOperations {
    ...
    private static List<String> buildArray(int[] target, int n) {
        ...
        for (int streamNumber = 1; streamNumber <= n; streamNumber++) {

            result.add("Push");

            if (target[targetIndex] == streamNumber) {
                targetIndex++;
