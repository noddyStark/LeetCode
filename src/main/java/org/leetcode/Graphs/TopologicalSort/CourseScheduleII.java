...
//        int[][] prerequisites = {};
        ...
        int[] answer = topoSort(numCourses, prerequisites);

        System.out.println("topo Sort is = " + Arrays.toString(answer));
    }
    ...
    private static int[] createIndegreeArray(int numCourses, ArrayList<ArrayList<Integer>> adjacencyList) {
        ...
        for (int i = 0; i < numCourses; i++) {
            ArrayList<Integer> courses = adjacencyList.get(i);
